...
**Projekt:** einfachbewussterleben.de – CRM Funnel  
**Datum:** 18. Juni 2026  
**Erstellt für:** Stefanie Dinçer  
...
|---|---|---|---|
| 1 | **Restbetrag Basisstruktur** | Ausstehender Restbetrag aus dem ursprünglichen Projektauftrag (Funnel-Seiten, Formulare, Zahlungsstrecke, E-Mail-Serie, CRM-Einrichtung, Übergabe) | **250,00 €** |
| 2 | **Mitgliederbereich** | Login-System, persönliches Dashboard, Kurszugang nach Kauf, DSGVO-Funktionen (Datenexport & Account-Löschung) – nicht im ursprünglichen Bid enthalten | **250,00 €** |
...
| | |
|---|---|
| Offene Beträge (Basis + Mitgliederbereich) | **500,00 €** |
| Zusatzleistungen (zweiter Funnel) | **150,00 €** |
| **Gesamtbetrag offen** | **650,00 €** |
...
*Alle Beträge zzgl. gesetzlicher MwSt., sofern zutreffend.*
